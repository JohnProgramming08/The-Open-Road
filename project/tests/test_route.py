...
@pytest.mark.parametrize("button_clicked, location, distance", [
	("setup", "", ""),
	("resupply", "", ""),
	("sell", "los_santos", "close"),
	("sell", "blaine_county", "far"),
	("security", "", ""),
	("staff", "", ""),
	("equipment", "", "")
])
def test_management_page_post(one_owned_business_client, button_clicked, location, distance):
	data = {
